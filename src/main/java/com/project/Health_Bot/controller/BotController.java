...
import com.project.Health_Bot.filter.FiltroEta;
...
public class BotController {
    ...
    @PostMapping
    public String getStat(@RequestBody GestoreFiltri gest) throws FilterArgumentException {

        ((FiltroEta) gest.getFiltriUser().get(0)).validate();
        return "";
